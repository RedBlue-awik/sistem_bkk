                    ...
                    <li class="nav-item dropdown user-menu">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            ...
                            <li class="user-header bg-secondary-subtle">
                                ...
                                <?php $kondisi = ($_SESSION["level"] == "admin") ? 'bg-danger-subtle' : 'bg-success' ?>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="input-group my-3">
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control telepone" name="telepon" id="telepon" maxlength="14" placeholder="" required autocomplete="off">
                                    <label for="telepon" class="form-label">No Telepon</label>
                                </div>
                            </div>
                            <span class="fw-bold text-center mt-3 mb-1">
                                <p>-- Tambahkan Akun Admin --</p>
                            </span>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="input-group my-3">
                                    <div class="input-group-text px-3"><span class="fas fa-phone"></span></div>
                                    <div class="form-floating">
                                        <input type="text" class="form-control telepone" name="telepon" id="telepon<?= $admin["id_admin"]; ?>" maxlength="14" placeholder="" required value="<?= $admin["telepon"]; ?>" autocomplete="off">
