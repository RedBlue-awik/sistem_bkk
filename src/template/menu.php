        ...
        <?php } else if ($_SESSION["level"] == "admin") { ?>
            <nav class="mt-2">
                ...
                <ul
                    ...
                    <li class="nav-item">
                        <a href="../../pages/public/daftar_backup.php" class="nav-link mt-2 d-flex align-items-center">
                    ...
                    <li class="nav-item">
                        <a href="../../logout.php" class="nav-link mt-3 btn-logout align-items-center d-flex">
